...
st.markdown("<h2 style='text-align: center;'>Door de stappen te volgens in het linker menu kunt u zien hoe verschillende factoren invloed hebben op uw pensioen.</h2>", unsafe_allow_html=True)
