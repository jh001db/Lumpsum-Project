...
st.markdown("<h2 style='text-align: center;'>Door de stappen te volgen in het linker menu kunt u zien hoe verschillende factoren invloed hebben op uw pensioen.</h2>", unsafe_allow_html=True)
...
if SB2 > 0:
    ...
    with graph_014:
        st.markdown("<h1 style='text-align: center;'>Pensioen</h1>", unsafe_allow_html=True)
    if SB13 > 950: st.markdown(f"<h2 style='text-align: center;'>{'€ '}{SB23:.2f}</h2>", unsafe_allow_html=True)
    else:
        pass
    with graph_015:
        st.markdown("<h1 style='text-align: center;'>Percentage</h1>", unsafe_allow_html=True)
